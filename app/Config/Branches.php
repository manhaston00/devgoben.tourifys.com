...
class Branches extends BaseController
{
    ...
    protected function denyIfNoAnyPermission(array $permissionKeys)
    {
    ...
    protected function findTenantBranch(int $branchId): ?array
    {
    ...
    {
        if ($guard = $this->denyIfNoPermission('branches.view')) {
            return $guard;
        }
        ...
        $this->writeAuditLog([
            ...
            'target_type'  => 'branch',
            'target_id'    => 0,
            'action_key'   => 'branches.index',
            'action_label' => lang('app.branches'),
            'meta_json'    => [
                'screen'    => 'branches/index',
                'tenant_id' => $tenantId,
    ...
    public function create()
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            $branchId = (int) $this->branchModel->getInsertID();

            $this->writeAuditLog([
                'branch_id'    => $branchId,
                'target_type'  => 'branch',
                'target_id'    => $branchId,
                'action_key'   => 'branches.create',
                'action_label' => lang('app.add_branch'),
                'meta_json'    => [
                    'tenant_id'   => $this->currentTenantId(),
                    'branch_code' => trim((string) $this->request->getPost('branch_code')),
                ],
        ...
        $this->writeAuditLog([
            ...
            'target_type'  => 'branch',
            'target_id'    => 0,
            'action_key'   => 'branches.create_form',
            'action_label' => lang('app.add_branch'),
            'meta_json'    => [
                'screen'    => 'branches/create',
                'tenant_id' => $this->currentTenantId(),
            ],
        ]);
    ...
    {
        if ($response = $this->denyIfNoAnyPermission(['branches.edit', 'branches.settings'])) {
            return $response;
        }

        $branch = $this->findTenantBranch((int) $id);
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            $this->writeAuditLog([
                ...
                'target_type'  => 'branch',
                'target_id'    => (int) $id,
                'action_key'   => 'branches.update',
                'action_label' => lang('app.edit_branch'),
                'meta_json'    => [
                    'tenant_id'   => $this->currentTenantId(),
        ...
        $this->writeAuditLog([
            ...
            'target_type'  => 'branch',
            'target_id'    => (int) $id,
            'action_key'   => 'branches.edit_form',
            'action_label' => lang('app.edit_branch'),
            'meta_json'    => [
                'screen'    => 'branches/edit',
                'tenant_id' => $this->currentTenantId(),
            ],
        ]);
