    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle mb-0">
                <tbody>
                    <tr>
                        <th width="250"><?= esc(lang('app.tenant_code')) ?></th>
                    ...
                    <tr>
                        ...
                        <td><?= esc($row['subscription_status'] ?? '-') ?></td>
                    </tr>

                    <tr>
                        <th><?= esc(lang('app.billing_type')) ?></th>
                        <td><?= esc($row['billing_type'] ?? '-') ?></td>
                    </tr>

                    <tr>
                        <th><?= esc(lang('app.start_date')) ?></th>
                        <td><?= esc($row['subscription_start_date'] ?? '-') ?></td>
                    </tr>

                    <tr>
                        <th><?= esc(lang('app.end_date')) ?></th>
                        <td><?= esc($row['subscription_end_date'] ?? '-') ?></td>
                    </tr>
