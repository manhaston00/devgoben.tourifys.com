...
<div class="card card-soft">
    <div class="card-body">
        <h5 class="mb-3"><?= lang('app.create_branch') ?></h5>
        ...
        <form method="post" action="<?= site_url('branches/create') ?>">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="branch_name_th" class="form-control" value="<?= old('branch_name_th') ?>" required>
                </div>

                <div class="col-md-5">
                    <label class="form-label"><?= lang('app.branch_name_en') ?></label>
                    <input type="text" name="branch_name_en" class="form-control" value="<?= old('branch_name_en') ?>">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="address_th" class="form-control" rows="3"><?= old('address_th') ?></textarea>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <select name="default_locale" class="form-select">
                        <option value="th" <?= old('default_locale', 'th') === 'th' ? 'selected' : '' ?>><?= lang('app.thai') ?></option>
                        <option value="en" <?= old('default_locale') === 'en' ? 'selected' : '' ?>><?= lang('app.english') ?></option>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="opened_at" class="form-control" value="<?= old('opened_at') ?>">
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-select">
                        <option value="1" <?= old('status', '1') === '1' ? 'selected' : '' ?>><?= lang('app.active') ?></option>
                        <option value="0" <?= old('status') === '0' ? 'selected' : '' ?>><?= lang('app.inactive') ?></option>
                    </select>
                </div>

                <div class="col-12">
                    <div class="form-check">
                        <input type="checkbox" name="is_head_office" id="is_head_office" class="form-check-input" value="1" <?= old('is_head_office') ? 'checked' : '' ?>>
